...
public class MessengerRegistrationForm {
	...
	@Pattern(regexp = "^[0-9]{4}[А-Я]{2}[1-6]{1}$", message = "Must be formatted 1111КР6")
	private String carNumber;

	public Messenger toMessenger(PasswordEncoder passwordEncoder) {
		return new Messenger(carNumber, new StaffInfo(workExperience, passportNumber,
